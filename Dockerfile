...
RUN sed -i  "0,/enabled=0/{s/enabled=0/enabled=1/}" /etc/yum.repos.d/remi-php70.repo
...
php-pear php-pecl-mongodb composer vim wget git bash-completion && yum clean all
